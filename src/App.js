...
function TodoList() {
    const initialTodos = [
        { id: 1, date: '2023-11-25', task: 'Math Homework', completed: false, priority: 'High', notes: 'Chapter 5 and 6' },
        { id: 2, date: '2023-11-26', task: 'Physics Assignment', completed: true, priority: 'Medium', notes: 'Experiment report' },
        { id: 3, date: '2023-11-27', task: 'History Reading', completed: false, priority: 'Low', notes: 'Read pages 101-120' }
    ];
